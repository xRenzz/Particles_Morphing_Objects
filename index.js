...
const particleImage = 'https://motionarray.imgix.net/preview-313169-EvDw8lSTvc-high_0001.jpg?w=660&q=60&fit=max&auto=format',
particleColor = '0xFFFFFF',
particleSize = 0.2;

const defaultAnimationSpeed = 0.7,
morphAnimationSpeed = 5;
...
tetrahedronParticles = new THREE.Geometry();
...
tetrahedronPoints = THREE.GeometryUtils.randomPointsInGeometry(geometry, particleCount);
...
createVertices(tetrahedronParticles, tetrahedronPoints, null, 4);
...
triggers[4].addEventListener('click', toPyramid);
